...
import BoardSummaryPage from '../pages/boardSummary/BoardSummaryPage';
      ...
      children: [
        {
          ...
          {
            path: pathConstants.BOARD_SUMMARY,
            element: <BoardSummaryPage />,
            errorElement: <ErrorPage />,
            loader: checkAdminRole,
            children: [
              {
                path: '',
                element: <Navigate to={pathConstants.BOARD_SUMMARY_ID} />,
                loader: checkAuth
              },
              {
                path: pathConstants.BOARD_SUMMARY_ID,
                element: <BoardSummaryPage />,
                loader: checkAuth
              }
            ]
